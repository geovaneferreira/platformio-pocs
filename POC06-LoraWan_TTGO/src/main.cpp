...
/* - Chaves (Network Keys) */
//CHAGE FILE "credentials.h"
static const PROGMEM u1_t NWKSKEY[16] =  network_session_key; //coloque aqui sua network session key
/* - Chaves (Application Keys) */
static const u1_t PROGMEM APPSKEY[16] =  application_session_key; //coloque aqui sua application session key
